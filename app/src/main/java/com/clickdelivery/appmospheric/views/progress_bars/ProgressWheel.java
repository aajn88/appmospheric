package com.clickdelivery.appmospheric.views.progress_bars;
...
/**
 * An indicator of progress, similar to Android's ProgressBar. Can be used in 'spin mode' or
 * 'increment mode'
 *
 * @author Todd Davies
 *         <p/>
...
public class ProgressWheel extends View {
    ...
    private void setupPaints() {
        ...
        if (!isInEditMode()) {
            textPaint.setTypeface(
                    Typeface.createFromAsset(getContext().getAssets(), "fonts/Fontello.ttf"));
        }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_barLengthPb, barLength);
