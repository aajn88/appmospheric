package com.clickdelivery.appmospheric.views.font;
	...
	public static Typeface getRoboto(Context context, int typeface) {
		...
		case Roboto.ROBOTO_BOLD_CONDENSED_ITALIC:
			if (Roboto.sRobotoBoldCondensedItalic == null) {
				Roboto.sRobotoBoldCondensedItalic = Typeface.createFromAsset(context.getAssets(),
		...
		case Roboto.ROBOTO_CONDENSED_ITALIC:
			if (Roboto.sRobotoCondensedItalic == null) {
				Roboto.sRobotoCondensedItalic = Typeface
						.createFromAsset(context.getAssets(), "fonts/Roboto-CondensedItalic.ttf");
			}
